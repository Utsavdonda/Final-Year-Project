...
abstract class AddSubcriptionRepository {
  Future<Either<ApiError, Map<String, dynamic>>> addSubscription(
      context, Map<String, dynamic> data);
}

class AddSubcriptionImplementation implements AddSubcriptionRepository {
  ...
  Future<Either<ApiError, Map<String, dynamic>>> addSubscription(
    ...
    try {
      ...
      var response = await (await _apiService.getDioClient())
          .post(APIEndpoints.addSubscription, data: data);
