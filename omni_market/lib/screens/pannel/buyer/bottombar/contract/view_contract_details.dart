...
class ViewContractDetailsScreen extends StatelessWidget {
  const ViewContractDetailsScreen({
    super.key,
    required this.index,
    required this.viewContractModel,
  });
  final int index;
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Text(
                        viewContractModel.data?[index].sellerId?.name ?? "",
                  ...
                  RichText(
                    text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                              text:
                                  viewContractModel.data?[index].totalAmount ??
                                      '',
                              style: AppTextStyle.mediumTextStyle
                                  .copyWith(color: AppColors.blackColor)),
                        ]),
                  ...
                  RichText(
                    text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text:
                                viewContractModel.data?[index].startDate ?? '',
                            style: AppTextStyle.mediumTextStyle
                                .copyWith(color: AppColors.blackColor),
                          ),
                        ]),
                  ...
                  RichText(
                    text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text: viewContractModel.data?[index].endDate ?? '',
                            style: AppTextStyle.mediumTextStyle
                                .copyWith(color: AppColors.blackColor),
                          ),
                        ]),
                  ...
                  Wrap(
                    children: List.generate(
                        viewContractModel.data?[index].diamondName?.length ?? 0,
                        (index1) => Padding(
                              padding:
                  ...
                  Wrap(
                    children: List.generate(
                        viewContractModel.data?[index].qualityOfRough?.length ??
                            0,
                        (index1) => Padding(
                              padding:
                                  EdgeInsets.symmetric(vertical: Sizes.s4.h),
                  ...
                  Wrap(
                    children: List.generate(
                        viewContractModel.data?[index].polishType?.length ?? 0,
                        (index1) => Padding(
                              padding:
                                  EdgeInsets.symmetric(vertical: Sizes.s4.h),
                              child: SkillChip(
                  ...
                  Wrap(
                    children: List.generate(
                        viewContractModel.data?[index].polishColor?.length ?? 0,
                        (index1) => Padding(
                              padding:
                                  EdgeInsets.symmetric(vertical: Sizes.s4.h),
                              child: SkillChip(
