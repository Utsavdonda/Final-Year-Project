...
import 'package:omni_market/screens/pannel/buyer/bottombar/home/subscription/subscription_plan_details_screen.dart';
import 'package:omni_market/widgets/common/app_bar.dart';
import 'package:omni_market/widgets/navigation.dart';

// ignore: must_be_immutable
class BuyerSubscriptionsScreen extends StatelessWidget {
  BuyerSubscriptionsScreen({super.key});
  ...
  List<Map<String, dynamic>> subscriptionsPlans = [
    {
      ...
      "price": 10000,
      "time": "12",
      "features": ["You can see verified users", "Protection from fake users"],
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    onTap: () {
                      navigationPush(
                          context,
                          BuyerSubscriptionDetails(
                              plan: subscriptionsPlans[index]));
                    },
                  );
                },
              ),
